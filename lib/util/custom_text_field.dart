...
class CustomTextField extends StatefulWidget {
  ...
  const CustomTextField(
      ...
      this.height = 50,
        ...
        this.horizontalSize = 23,
        this.verticalSize = 23,
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.borderRadius!),
              borderSide: BorderSide(color: widget.isShowBorder! ?AppColors.primaryColorLight : Colors.blue, width: widget.isShowBorder! ? 1 : 0)),
          focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(widget.borderRadius!),
              borderSide:
              BorderSide(color: widget.isShowBorder! ? colorPrimaryLight : AppColors.primaryColorDark, width: widget.isShowBorder! ? 0.2 : 0)),
          isDense: true,
